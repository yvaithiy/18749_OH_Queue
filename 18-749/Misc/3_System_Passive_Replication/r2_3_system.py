    ...
    while a == 1:
        ...
        while True:
            ...
            if int(recemsgsplit[0]) != membership:
                ...
                checkpoint_flag = 0
                if primary == 0 and recemsgsplit[1] == '0':
                    if recemsgsplit[2] == '0':
                        primary = 2
                    else:
                        primary = 1
                if primary == 1 and recemsgsplit[2] == '0':
                    if recemsgsplit[1] == '0':
                        primary = 2
                    else:
                        primary = 0
                if primary == 2 and recemsgsplit[3] == '0':
                    if recemsgsplit[1] == '0':
                        primary = 0
                    else:
                        primary = 1
...
def send_data2():
    ...
    for addr in REPLICA_IP_LIST:
        if addr is not HOST_IP and addr is not "0":
            s_d(addr)
            a = a + 1
