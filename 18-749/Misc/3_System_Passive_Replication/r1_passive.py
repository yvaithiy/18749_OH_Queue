...
HOST_IP = '128.237.139.215'#socket.gethostbyname(socket.gethostname())
HEARTBEAT_FREQ = 1
                ...
                if checkpoint_flag == 5:
                    ...
                    for i in range(len(PREV_REPLICA_IP_LIST)):
                        if PREV_REPLICA_IP_LIST[i] != "0":
                            SENDER_1 = PREV_REPLICA_IP_LIST[i]
                            break
